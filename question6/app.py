...
def addInventory():                  
    '''
    It adds the data to the table
    it take input from user in form of json body with below kwy-values
    itemname:string
    vendorName:string
    quantordered:int
    quantRemaining:int
...
def updateInventory(id):     
    '''
    It updates the data in the table based on id 
    it take input from user in form of json body with below kwy-values and update the particular row
    itemname:string
    vendorName:string
    quantordered:int
    quantRemaining:int
...
def deleteInventory(id):        #it deletes a row in the table based on id 
    row=Inventory.query.filter_by(id=id).first()
